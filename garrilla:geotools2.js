 ...
 GT_OSGB = function()
{
    ...
    if (!(this instanceof GT_OSGB)) return new GT_OSGB();
...
{
    // allow instantiation without 'new'
    if (!(this instanceof GT_Irish)) return new GT_Irish();
...
if (typeof module != 'undefined' && module.exports) module.exports = GT_Irish; // CommonJS
if (typeof define == 'function' && define.amd) define([], function() { return GT_Irish; }); // AMDvar x,y;
...
{
    // allow instantiation without 'new'
    if (!(this instanceof GT_WGS84)) return new GT_WGS84();
...
if (typeof module != 'undefined' && module.exports) module.exports = GT_WGS84; // CommonJS
if (typeof define == 'function' && define.amd) define([], function() { return GT_WGS84; }); // AMD
